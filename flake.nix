    ...
    in
    {
      overlays.default = _: prev:
        let
          ...
          # vendorHash is regenerated by running `nix-vendor-sri` inside `nix develop`.
          # Keep in sync after every change to go.mod / go.sum.
          vendorHash = null;
        in
        {
          gigahost = buildGo {
          ...
          terraform-provider-gigahost = buildGo {
            ...
            src = pkgs.lib.cleanSource (self + "/terraform-provider-gigahost");
