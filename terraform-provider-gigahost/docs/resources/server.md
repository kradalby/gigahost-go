...
- `id` (String) IP ID, used by `gigahost_server_rdns` and `gigahost_bgp_session`.
- `reverse` (String) Reverse DNS (PTR) name set for the address.
- `subnet_id` (String) Subnet ID the address belongs to.
- `type` (String) Address type reported by the API, e.g. `l2` or `l3`.
