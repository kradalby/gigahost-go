...
type DeployService struct {
	...
	// catalog memoises the product catalog: it describes what Gigahost sells,
	// and every resource that resolves a size or region used to fetch it
	// again.
	catalog cached[*DeployCatalog]
}
