...
// implementations. The exported types use [encoding/json/v2] semantics.
//
// # Stability
//
// This module carries no version tags; importers get a pseudo-version. The
// exported API is pre-1.0 and may change without notice — it tracks a vendor
// API that is itself still moving, and every quirk worked around here is
// recorded in docs/upstream-issues.md in the repository.
package client
