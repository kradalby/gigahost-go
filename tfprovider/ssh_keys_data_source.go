	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			"keys": schema.ListNestedAttribute{
				MarkdownDescription: "The account's SSH keys.",
				Computed:            true,
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"id":         schema.StringAttribute{MarkdownDescription: "Unique identifier.", Computed: true},
						"name":       schema.StringAttribute{MarkdownDescription: "Key name as registered on the account.", Computed: true},
						"public_key": schema.StringAttribute{MarkdownDescription: "The SSH public key in `authorized_keys` form.", Computed: true},
						"added_at": schema.Int64Attribute{
							MarkdownDescription: "When the key was added (Unix seconds).",
							Computed:            true,
						},
					},
				},
