	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"tiers": schema.ListNestedAttribute{
				MarkdownDescription: "Catalog tiers, each grouping comparable products.",
				Computed:            true,
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"group_id":   schema.StringAttribute{MarkdownDescription: "Internal ID of the catalog tier.", Computed: true},
						"group_name": schema.StringAttribute{MarkdownDescription: "Catalog tier name, e.g. `KVM Value`.", Computed: true},
						"products": schema.ListNestedAttribute{
							MarkdownDescription: "Products within the tier.",
							Computed:            true,
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
									"product_id":   schema.StringAttribute{MarkdownDescription: "Raw catalog product ID, required to deploy.", Computed: true},
									"price_id":     schema.StringAttribute{MarkdownDescription: "Raw catalog price ID, required to deploy.", Computed: true},
									"name":         schema.StringAttribute{MarkdownDescription: "Product name as shown in the control panel.", Computed: true},
									...
									"slug":         schema.StringAttribute{MarkdownDescription: "Stable slug used to select this by name.", Computed: true},
									...
									"region_ids": schema.ListAttribute{
										MarkdownDescription: "IDs of the regions this can be deployed to.", Computed: true,
