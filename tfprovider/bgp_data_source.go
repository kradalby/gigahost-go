	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			"asns": schema.ListNestedAttribute{
				MarkdownDescription: "Autonomous system numbers registered on the account.",
				Computed:            true,
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"id":      schema.StringAttribute{MarkdownDescription: "Unique identifier.", Computed: true},
						"asn":     schema.StringAttribute{MarkdownDescription: "Autonomous system number.", Computed: true},
						"name":    schema.StringAttribute{MarkdownDescription: "ASN name as registered.", Computed: true},
						"status":  schema.StringAttribute{MarkdownDescription: "Approval status of the ASN.", Computed: true},
						"country": schema.StringAttribute{MarkdownDescription: "Country the ASN is registered in.", Computed: true},
					},
				},
			},
			"sessions": schema.ListNestedAttribute{
				MarkdownDescription: "BGP sessions configured on the account.",
				Computed:            true,
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"id":            schema.StringAttribute{MarkdownDescription: "Unique identifier.", Computed: true},
						"asn_id":        schema.StringAttribute{MarkdownDescription: "Internal ID of the ASN record.", Computed: true},
						"status":        schema.StringAttribute{MarkdownDescription: "Approval status of the ASN.", Computed: true},
						"ip_type":       schema.StringAttribute{MarkdownDescription: "Address family of the peering address.", Computed: true},
						"ip_address":    schema.StringAttribute{MarkdownDescription: "IP address the session peers from.", Computed: true},
						"neighbor_ipv4": schema.StringAttribute{MarkdownDescription: "IPv4 address of the BGP neighbour.", Computed: true},
						"neighbor_ipv6": schema.StringAttribute{MarkdownDescription: "IPv6 address of the BGP neighbour.", Computed: true},
						"default_route": schema.BoolAttribute{MarkdownDescription: "True when the session receives the default route.", Computed: true},
					},
				},
			},
		},
